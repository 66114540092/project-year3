...
SECRET_KEY = "django-insecure-r0bq6a$lr*gd2+(25clnauy)*r+@#c3(k93dgvse!(w9dc%3#+"
DEBUG = True
...
TEMPLATES = [
    {
        ...
        # 👇 บอก Django ว่า templates อยู่ที่นี่
...
CSRF_TRUSTED_ORIGINS = ['https://fa11da607ba5.ngrok-free.app']
